    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-6 md:flex">
          <Link
            href="/calculator"
            className="flex items-center gap-1.5 text-sm font-medium text-fuchsia-700 hover:text-fuchsia-800"
          >
      ...
      {mobileMenuOpen && (
        <div className="border-t border-gray-200 bg-white md:hidden">
          <div className="space-y-1 px-4 py-3">
            <Link
              href="/calculator"
              className="flex items-center gap-2 rounded-lg px-3 py-2 text-base font-medium text-fuchsia-700 hover:bg-fuchsia-50 hover:text-fuchsia-800"
